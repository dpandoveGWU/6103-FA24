...
# %%
# The refined model, even with a slightly worse Log-Likelihood, is considered better overall because it achieves a lower AIC. This suggests that dropping the insignificant variables (parch and fare) made the model simpler without sacrificing much predictive power.
