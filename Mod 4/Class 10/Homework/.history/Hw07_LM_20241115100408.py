...
# %%
coef_pclass = -1.1455
"""Passenger Class (pclass=): Passengers in higher classes (1st class) had a significantly better chance of survival. The odds of survival decrease as the class number increases (i.e., moving from 1st to 3rd class).
