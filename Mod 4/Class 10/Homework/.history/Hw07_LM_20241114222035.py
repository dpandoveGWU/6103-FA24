...
# Map 'sex' to numeric values and create dummy variables for 'pclass'
titanic['sex'] = titanic['sex'].map({'male': 1, 'female': 0})
titanic_data = pd.get_dummies(titanic, columns=['pclass'], drop_first=True)

# Fill missing values in 'age' and ensure data is numeric
...
# Verify that y contains only binary values
print("Unique values in y:", y.unique())

# Convert X and y to NumPy arrays, ensuring no dtype conflicts
...
titanic_data['age'].fillna(titanic['age'].median(), inplace=True)
