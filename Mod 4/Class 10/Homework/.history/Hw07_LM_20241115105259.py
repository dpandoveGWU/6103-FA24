...
# %%
"""Away teams have consistently higher success rates than home teams across all distance ranges. The disparity is particularly notable for field goals over 50 yards, where away teams outperform home teams by a wide margin. This suggests that the difference in success is not limited to specific distances but is more pronounced for longer attempts."""
