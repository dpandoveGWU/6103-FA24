...
# Define a function to calculate metrics at different cut-offs
...
# Evaluate for different cut-off values
cut_off_values = [0.3, 0.5, 0.7]
for cut_off in cut_off_values:
    accuracy, precision, recall = evaluate_model(logit_model_refined, X_test, y_test, cut_off)
