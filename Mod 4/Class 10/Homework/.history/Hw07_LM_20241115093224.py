...
# Step 1: Drop unnecessary columns ('id', 'ticket')
...
# Step 3: Manually encode 'sex' and 'embarked' columns
...
# Add a constant to the feature set (intercept)
X = sm.add_constant(X)
...
# %%
# Step 2: Compare Log-Likelihood and AIC
