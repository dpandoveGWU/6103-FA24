...
# 1b. Proportion summary of male-female and survived-dead

# Proportion of male and female passengers
gender_proportion = titanic_data['sex'].value_counts(normalize=True)

# Proportion of survived and dead passengers
survival_proportion = titanic_data['survived'].value_counts(normalize=True)
