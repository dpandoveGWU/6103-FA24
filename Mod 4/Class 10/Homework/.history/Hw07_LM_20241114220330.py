...
# Handle missing values in the 'age' column by filling with the median (you can adjust this strategy if needed)
...
# Check for object types and cast to numeric to prevent any issues
