...
# %%
# Define a mapping for happiness levels if it’s categorical
happy_mapping = {
    "Very Happy": 3,
    "Pretty Happy": 2,
    "Not Too Happy": 1,
...
# Apply the mapping
df["happy"] = df["happy"].map(happy_mapping)

# Check for non-NaN values in 'childs' and 'happy' columns
print(df[["childs", "happy"]].info())  # Check data types and non-null counts
print(df[["childs", "happy"]].head())  # Print first few rows to verify content
# %%
