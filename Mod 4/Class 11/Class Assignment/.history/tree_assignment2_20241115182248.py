...
oj_data['Purchase'] = oj_data['Purchase'].replace({'CH': 0, 'MM': 1})
...
# %%
maxlevels = [None, 2, 3, 5, 8]   # none: doesnt get devided, 
...
plot_tree(tree_model,max_depth=3, feature_names=X.columns, class_names=['CH', 'MM'], filled=True)
