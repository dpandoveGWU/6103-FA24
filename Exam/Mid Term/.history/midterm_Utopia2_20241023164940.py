...
# from box plot2 world 2 (right plot), on the other hand, exhibits a more balanced income distribution across all ethnic groups. The income range is narrower and more consistent, suggesting less income inequality among ethnic groups.
