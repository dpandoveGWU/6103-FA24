...
# %%
# Correlation matrices for World 1 and World 2
plt.figure(figsize=(14, 6))

# World 1: Correlation Matrix
plt.subplot(1, 2, 1)
sns.heatmap(world1.corr(), annot=True, cmap='coolwarm', vmin=-1, vmax=1)
plt.title('World 1: Correlation Matrix')

# World 2: Correlation Matrix
plt.subplot(1, 2, 2)
sns.heatmap(world2.corr(), annot=True, cmap='coolwarm', vmin=-1, vmax=1)
plt.title('World 2: Correlation Matrix')
...
# This similarity suggests that in terms of income equality, neither world is clearly more utopian than the other based solely on the Gini coefficient.

# %%

# Plotting age distribution across industries for both worlds
plt.figure(figsize=(14, 6))

# World 1: Age Representation in Industries
plt.subplot(1, 2, 1)
sns.boxplot(x='industry', y='age00', data=world1)
plt.title('World 1: Age Distribution Across Industries')

# World 2: Age Representation in Industries
plt.subplot(1, 2, 2)
sns.boxplot(x='industry', y='age00', data=world2)
plt.title('World 2: Age Distribution Across Industries')

plt.tight_layout()
plt.show()

# %%
# Plotting proportion of married individuals by industry
plt.figure(figsize=(14, 6))

# World 1: Proportion of Married Individuals by Industry
plt.subplot(1, 2, 1)
sns.barplot(x='industry', y='marital', data=world1[world1['marital'] == 1], estimator=lambda x: len(x) / len(world1))
plt.title('World 1: Proportion of Married Individuals by Industry')

# World 2: Proportion of Married Individuals by Industry
plt.subplot(1, 2, 2)
sns.barplot(x='industry', y='marital', data=world2[world2['marital'] == 1], estimator=lambda x: len(x) / len(world2))
plt.title('World 2: Proportion of Married Individuals by Industry')
