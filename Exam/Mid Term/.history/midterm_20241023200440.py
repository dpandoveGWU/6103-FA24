...
# # Two Worlds 
# 
# I was searching for uptopia, and came to this conclusion: If you want to do it right, do it yourself. 
...
# The above plot indicates that World 1 exhibits significant gender imbalances, with industries like
#  finance dominated by males and education by females. 
# In contrast, World 2 shows better gender representation and a 
# more equitable distribution across industries. 
# This supports Hypothesis 1, as the two worlds significantly differ in social conditions. Furthermore, the improved gender balance in World 2 aligns with the characteristics of an ideal society, supporting Hypothesis 2 that this world demonstrates more utopian traits.
# %%
...
# the plot indicates that World 1 exhibits greater income disparity among ethnic groups, 
# suggesting a level of marginalization. In contrast, World 2 shows a more balanced income distribution, reflecting better ethnic equality. This finding supports Hypothesis 1, as the two worlds significantly differ in income distribution. Additionally, the equitable income distribution 
# in World 2 aligns with the characteristics of a utopian society, supporting Hypothesis 2 that this world demonstrates more ideal traits.
# %%
...
# World 1 experiences greater income inequality as education levels rise, with highly educated individuals earning disproportionately more. In contrast, World 2 demonstrates a more
#  balanced income distribution across all education levels, indicating that education does not lead to significant income disparities. This supports Hypothesis 1, as the two worlds differ significantly in income distribution based on education. Additionally, World 2's balanced distribution aligns with utopian ideals, supporting Hypothesis 2 
# that this world exhibits more utopian characteristics.
...
# World 1 shows that certain ethnic groups dominating higher-paying industries like finance and business. In contrast, World 2 displays more balanced ethnic representation across all industries, suggesting greater social fairness. This supports Hypothesis 1, as the two worlds differ significantly in ethnic representation within industries. 
# Additionally, the balanced ethnic distribution in World 2 aligns with utopian ideals, supporting Hypothesis 2 that this world exhibits more ideal characteristics.
# %%
...
# %%
                ...
                #  Conclusion:
# From all the above analysis I want to conclude that neither fully support a utopian society, though World 2 comes closer.

# In World 1, there are clear signs of inequality: certain industries are dominated by specific genders, with males concentrated in finance and females in education. There are Income inequality, particularly among ethnic groups and across education levels. The Gini coefficient, which measures income inequality, is higher in World, which indicates a greater concentration of wealth among specific groups. Ethnic marginalization is also evident in higher-paying industries, where certain groups dominate, pointing to unequal access to economic opportunities.
# In contrast, World 2 demonstrates more equitable social and economic conditions. Gender representation across industries is more balanced, and income distribution shows fewer disparities across both ethnic groups and education levels. The Gini coefficient is lower in World 2, which shows a more equal distribution of income. Ethnic groups are more evenly represented in all industries, suggesting greater social fairness. While not a perfect utopia, World 2 exhibits many characteristics aligned with utopian ideals, such as income equality, balanced gender representation, and ethnic diversity.
