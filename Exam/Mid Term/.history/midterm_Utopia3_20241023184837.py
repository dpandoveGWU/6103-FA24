...
# %%
# Plotting income distribution by age for World 1 and World 2
import matplotlib.pyplot as plt
import seaborn as sns
# %%
plt.figure(figsize=(14, 6))

# World 1: Income by Age
plt.subpl
ot(1, 2, 1)
sns.boxplot(x='age00', y='income00', data=world1)
plt.title('World 1: Income Distribution by Age')
plt.xticks(rotation=45)

# World 2: Income by Age
plt.subplot(1, 2, 2)
sns.boxplot(x='age00', y='income00', data=world2)
plt.title('World 2: Income Distribution by Age')
plt.xticks(rotation=45)
