...
# Pivot table for income by gender and ethnicity in World 1
pivot_gender_ethnicity_w1 = pd.pivot_table(world1, values='income00', index='gender', columns='ethnic', aggfunc='mean')
pivot_gender_ethnicity_w2 = pd.pivot_table(world2, values='income00', index='gender', columns='ethnic', aggfunc='mean')

# Plotting income by gender and ethnicity for both worlds
fig, axes = plt.subplots(1, 2, figsize=(14, 6))

# World 1 Plot
sns.heatmap(pivot_gender_ethnicity_w1, annot=True, cmap="coolwarm", ax=axes[0])
axes[0].set_title('World 1: Average Income by Gender and Ethnicity')
axes[0].set_xlabel('Ethnicity')
axes[0].set_ylabel('Gender')

# World 2 Plot
sns.heatmap(pivot_gender_ethnicity_w2, annot=True, cmap="coolwarm", ax=axes[1])
axes[1].set_title('World 2: Average Income by Gender and Ethnicity')
