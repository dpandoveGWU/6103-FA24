...
# The analysis reveals that World 1 exhibits significant gender imbalances, with industries like
#  finance dominated by males and education by females. In contrast, World 2 shows better gender representation and a more equitable distribution across industries. This supports Hypothesis 1, as the two worlds significantly differ in social conditions. Furthermore, the improved gender balance in World 2 aligns with the characteristics of an ideal society, supporting Hypothesis 2 that this world demonstrates more utopian traits.
# %%
