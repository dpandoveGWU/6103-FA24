...
# T herefore, **Hypothesis 1 is partially supported**: While both worlds show some variation in the relationship between education and income, neither world exhibits a strong correlation between higher education and higher income.
