...
# Therefore, **Hypothesis 1 is partially supported**: While both worlds show some variation in the relationship between education and income, neither world exhibits a strong correlation between higher education and higher income.
                        ...
                        # Hypothesis 2:
# Both worlds show a lack of strong connectionbetween years of education and income, which challenges the utopian ideal of meritocracy, where higher education should lead to higher income. In a utopian society, we would expect a clearer upward trend, with individuals receiving more rewards for higher education.
