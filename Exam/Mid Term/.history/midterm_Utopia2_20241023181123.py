...
# Display the pivot tables for reference
pivot_world1, pivot_world2

# Drawing conclusions based on these pivot tables:

1. **Income**: In both worlds, men consistently earn slightly more than women across all industries. The income gap is larger in industries with higher average salaries (such as Professional/Business and Finance). This suggests gender disparity in income distribution, indicating that neither world is perfectly utopian in terms of gender income equality. However, World 2 shows a slightly smaller income gap overall compared to World 1.
