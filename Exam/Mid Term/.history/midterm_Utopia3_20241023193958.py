...
# more equitable distribution across industries. This supports Hypothesis 1, as the two worlds significantly differ in social conditions. Furthermore, the improved gender balance in World 2 aligns with the characteristics of an ideal society, supporting Hypothesis 2 that this world demonstrates more utopian traits.
# %%
