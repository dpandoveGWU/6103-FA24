...
from sklearn.metrics import mean_squared_error, r2_score, confusion_matrix, accuracy_score, precision_score, recall_score, f1_score, roc_auc_score, roc_curve
import matplotlib.pyplot as plt
...
X_reg_world1 = pd.get_dummies(world1[['industry', 'education', 'age00']], drop_first=True)
y_reg_world1 = world1['income00']
X_train_reg_w1, X_test_reg_w1, y_train_reg_w1, y_test_reg_w1 = train_test_split(X_reg_world1, y_reg_world1, test_size=0.3, random_state=42)

X_reg_world2 = pd.get_dummies(world2[['industry', 'education', 'age00']], drop_first=True)
y_reg_world2 = world2['income00']
X_train_reg_w2, X_test_reg_w2, y_train_reg_w2, y_test_reg_w2 = train_test_split(X_reg_world2, y_reg_world2, test_size=0.3, random_state=42)

# Classification Tree
X_class_world1 = X_reg_world1  # Same features for classification
y_class_world1 = world1['target']
X_train_class_w1, X_test_class_w1, y_train_class_w1, y_test_class_w1 = train_test_split(X_class_world1, y_class_world1, test_size=0.3, random_state=42)

X_class_world2 = X_reg_world2  # Same features for classification
y_class_world2 = world2['target']
X_train_class_w2, X_test_class_w2, y_train_class_w2, y_test_class_w2 = train_test_split(X_class_world2, y_class_world2, test_size=0.3, random_state=42)
...
y_pred_reg_w1 = tree_reg_w1.predict(X_test_reg_w1)

mse_w1 = mean_squared_error(y_test_reg_w1, y_pred_reg_w1)
r2_w1 = r2_score(y_test_reg_w1, y_pred_reg_w1)

print(f"Mean Squared Error (MSE): {mse_w1:.2f}")
print(f"R² Score: {r2_w1:.2f}")

# Plot the regression tree
plt.figure(figsize=(16, 8))
plot_tree(tree_reg_w1, feature_names=X_reg_world1.columns, filled=True, max_depth=3)
plt.title("Decision Tree Regression - World1")
plt.show()

# 2. Decision Tree Regression for World2
...
y_pred_reg_w2 = tree_reg_w2.predict(X_test_reg_w2)

mse_w2 = mean_squared_error(y_test_reg_w2, y_pred_reg_w2)
r2_w2 = r2_score(y_test_reg_w2, y_pred_reg_w2)

print(f"Mean Squared Error (MSE): {mse_w2:.2f}")
print(f"R² Score: {r2_w2:.2f}")

# Plot the regression tree
plt.figure(figsize=(16, 8))
plot_tree(tree_reg_w2, feature_names=X_reg_world2.columns, filled=True, max_depth=3)
plt.title("Decision Tree Regression - World2")
plt.show()

# 3. Classification Tree for World1
...
plt.figure(figsize=(16, 8))
plot_tree(tree_class_w1, feature_names=X_class_world1.columns, filled=True, max_depth=3)
plt.title("Classification Tree - World1")
plt.show()

# 4. Classification Tree for World2
...
# Plot the classification tree
plt.figure(figsize=(16, 8))
plot_tree(tree_class_w2, feature_names=X_class_world2.columns, filled=True, max_depth=3)
plt.title("Classification Tree - World2")
plt.show()
