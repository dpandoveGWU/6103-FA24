...
# %%[markdown]
# For the decision tree Pruning applied using cost complexity pruning (`ccp_alpha`), progressively adjusting alpha values to balance model complexity and performance.
