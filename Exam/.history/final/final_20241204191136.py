...
# The unpruned classification tree had better overall accuracy (83%) and ROC-AUC (0.91), while pruning imp but reduced accuracy (76%) and ROC-AUC (0.76), indicating a trade-off.
#%% [markdown]
#
