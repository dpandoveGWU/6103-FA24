...
# Display the mapping of features
feature_mapping = {f"x{i}": feature for i, feature in enumerate(all_features, start=1)}
print("Mapping of statsmodels output variables to features:")
