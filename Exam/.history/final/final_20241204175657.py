...
for feature in additional_features:
    if feature not in world1.columns or feature not in world2.columns:
        print(f"Feature {feature} is not found in the dataset. Skipping.")
        continue

    # Add feature to World1
    world1[feature] = preprocessor.fit_transform(world1[[feature]]) if feature in world1 else None
    X_train_w1[feature] = preprocessor.transform(world1[[feature]]) if feature in world1 else None
    ...
    world2[feature] = preprocessor.fit_transform(world2[[feature]]) if feature in world2 else None
    X_train_w2[feature] = preprocessor.transform(world2[[feature]]) if feature in world2 else None
