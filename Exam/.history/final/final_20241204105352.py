...
# Load the datasets
world1_path = '/mnt/data/world1.csv'
world2_path = '/mnt/data/world2.csv'

# Reading the datasets
world1 = pd.read_csv(world1_path, index_col="id")
world2 = pd.read_csv(world2_path, index_col="id")

# Display basic summaries of both datasets
world1_summary = world1.describe(include='all')
world2_summary = world2.describe(include='all')
...
import ace_tools as tools; tools.display_dataframe_to_user(name="World1 Summary", dataframe=world1_summary)
tools.display_dataframe_to_user(name="World2 Summary", dataframe=world2_summary)
