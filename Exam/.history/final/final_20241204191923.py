...
# Plot Feature Importance for World1 Classification
print("\nFeature Importance - Random Forest Classification - World1:")
plot_feature_importance(rf_class_w1, preprocessor.get_feature_names_out(), "World1 Classification")

# Plot Feature Importance for World2 Classification
print("\nFeature Importance - Random Forest Classification - World2:")
plot_feature_importance(rf_class_w2, preprocessor.get_feature_names_out(), "World2 Classification")
