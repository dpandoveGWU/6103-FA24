...
# %%[markdown]
# The KNN Classification model performed well for both World1 and World2, achieving high accuracy and balanced precision-recall with strong class distinction (ROC-AUC: 0.94).
# %%
