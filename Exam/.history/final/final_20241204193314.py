...
knn_reg_w2 = KNeighborsRegressor(n_neighbors=9)
...
knn_class_w1 = KNeighborsClassifier(n_neighbors=19)
...
# %%
# Tune k for KNN Classification
from sklearn.model_selection import GridSearchCV

# Define parameter grid
param_grid = {"n_neighbors": np.arange(1, 21)}

# GridSearch for World1 Classification
grid_search_class_w1 = GridSearchCV(KNeighborsClassifier(), param_grid, cv=5, scoring="roc_auc")
grid_search_class_w1.fit(X_train_class_w1, y_train_class_w1)
best_k_class_w1 = grid_search_class_w1.best_params_["n_neighbors"]
print(f"Best k for World1 Classification: {best_k_class_w1}")

# GridSearch for World1 Regression
grid_search_reg_w1 = GridSearchCV(KNeighborsRegressor(), param_grid, cv=5, scoring="neg_mean_squared_error")
grid_search_reg_w1.fit(X_train_reg_w1, y_train_reg_w1)
best_k_reg_w1 = grid_search_reg_w1.best_params_["n_neighbors"]
print(f"Best k for World1 Regression: {best_k_reg_w1}")
