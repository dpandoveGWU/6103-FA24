...
# Split Data for World1
X_train_w1, X_test_w1, y_train_w1, y_test_w1 = train_test_split(
    base_features_world1_encoded, world1['target'], test_size=0.3, random_state=42)

# Split Data for World2
X_train_w2, X_test_w2, y_train_w2, y_test_w2 = train_test_split(
    base_features_world2_encoded, world2['target'], test_size=0.3, random_state=42)

# Define a function to evaluate the logistic model
def train_logistic_model(X_train, y_train, X_test, y_test, title):
    X_train_sm = sm.add_constant(X_train)  # Add constant for intercept
    logit_model = sm.Logit(y_train, X_train_sm).fit()
...
# Step 1: Base Model with Industry for World1
print("\nWorld1 Base Model (Industry Only):")
logit_model_w1 = train_logistic_model(X_train_w1, y_train_w1, X_test_w1, y_test_w1, "World1 - Industry Only")

# Step 2: Add Education for World1
X_train_w1['education'] = world1.loc[X_train_w1.index, 'education']
X_test_w1['education'] = world1.loc[X_test_w1.index, 'education']
...
# Step 3: Add Interaction Term (Industry * Education) for World1
X_train_w1['industry_edu_interaction'] = X_train_w1['industry_1'] * X_train_w1['education']
X_test_w1['industry_edu_interaction'] = X_test_w1['industry_1'] * X_test_w1['education']

print("\nWorld1 Model (Industry + Education + Interaction):")
logit_model_w1_interaction = train_logistic_model(
    X_train_w1, y_train_w1, X_test_w1, y_test_w1, "World1 - Industry + Education + Interaction"
)
...
X_train_w2['education'] = world2.loc[X_train_w2.index, 'education']
X_test_w2['education'] = world2.loc[X_test_w2.index, 'education']
...
X_train_w2['industry_edu_interaction'] = X_train_w2['industry_1'] * X_train_w2['education']
X_test_w2['industry_edu_interaction'] = X_test_w2['industry_1'] * X_test_w2['education']

print("\nWorld2 Model (Industry + Education + Interaction):")
logit_model_w2_interaction = train_logistic_model(
    X_train_w2, y_train_w2, X_test_w2, y_test_w2, "World2 - Industry + Education + Interaction"
)
