...
y_pred = linear_model.predict(X_test)                             # Make predictions on the test set
...
print("World1 Linear Regression Summary:")
print(linear_model_sm_world1.summary())

# Predict and evaluate World1
y_pred = linear_model_sm_world1.predict(sm.add_constant(X_test))
rmse_world1 = mean_squared_error(y_test, y_pred, squared=False)
...
X_train_world2_sm = sm.add_constant(X_train_world2)  # Add constant for intercept
linear_model_sm_world2 = sm.OLS(y_train_world2, X_train_world2_sm).fit()
print("\nWorld2 Linear Regression Summary:")
print(linear_model_sm_world2.summary())

# Predict and evaluate World2
y_pred_world2 = linear_model_sm_world2.predict(sm.add_constant(X_test_world2))
rmse_world2 = root_mean_squared_error(y_test_world2, y_pred_world2, squared=False)
r2_world2 = r2_score(y_test_world2, y_pred_world2)
...
# Fit the linear regression model with renamed columns
X_train_sm_renamed = pd.DataFrame(sm.add_constant(X_train), columns=all_features)
linear_model_sm_renamed = sm.OLS(y_train, X_train_sm_renamed).fit()

# Display the summary with mapped feature names
print("World1 Linear Regression Summary with Feature Names:")
print(linear_model_sm_renamed.summary())
...
coefficients_world1 = linear_model.coef_
...
coefficients_world2 = linear_model_world2.coef_
