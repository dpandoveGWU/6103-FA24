...
# %%[markdown]
# The industries are the most important features for determining income in both World1 and World2, with `industry_7` (finance) and `industry_6` (professional/business) having the highest influence. Other features, such as marital status, ethnicity, age, education, and gender, are less significant in both worlds.
