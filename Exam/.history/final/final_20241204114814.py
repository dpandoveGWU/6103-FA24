...
# %%[markdown]
# or world1 The linear regression model explains 85.01% of the variability in income using features such as age, education, gender, marital status, and industry.
