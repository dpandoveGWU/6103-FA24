...
# Visualize feature importance for World1
plt.figure(figsize=(10, 6))
plt.barh(feature_importance_world1["Feature"], feature_importance_world1["Importance"], color='blue')
plt.title("Feature Importance - World1 (Linear Regression)")
plt.xlabel("Importance")
plt.ylabel("Feature")
plt.gca().invert_yaxis()  # Invert y-axis for better readability
plt.show()

# Visualize feature importance for World2
plt.figure(figsize=(10, 6))
plt.barh(feature_importance_world2["Feature"], feature_importance_world2["Importance"], color='green')
plt.title("Feature Importance - World2 (Linear Regression)")
plt.xlabel("Importance")
plt.ylabel("Feature")
plt.gca().invert_yaxis()  # Invert y-axis for better readability
plt.show()

# Display the top feature importance for both worlds in tabular format
import ace_tools as tools; tools.display_dataframe_to_user(name="Feature Importance - World1", dataframe=feature_importance_world1)
tools.display_dataframe_to_user(name="Feature Importance - World2", dataframe=feature_importance_world2)
