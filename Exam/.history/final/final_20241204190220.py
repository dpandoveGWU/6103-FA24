...
# %%[markdown]
# Pruning was applied using cost complexity pruning (`ccp_alpha`), progressively adjusting alpha values to balance model complexity and performance.
# Pruning improved performance until \( \alpha = 162,928.86 \), beyond which over-pruning reduced accuracy.
#%% [markdown]
#
