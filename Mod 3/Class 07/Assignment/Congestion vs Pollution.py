...
df = pd.read_excel('congestion vs pollution.xlsx')
...
# Now, let's create the scatter plot with the specified color mapping for pollution levels
import matplotlib.pyplot as plt

# Define colors based on pollution level
